...
export default function Map({ tracks, selectedTrack, onTrackClick, showMileMarkers, showStartFinish, cursorPosition, onMapHover, sidebarOpen, children }) {
  const mapRef = useRef();
  ...
  return (
    <div className="h-full w-full">
      ...
      >
        ...
        {/* Render children (e.g., DrawTrailMode) */}
        {children}
      </MapContainer>
    </div>
  );
