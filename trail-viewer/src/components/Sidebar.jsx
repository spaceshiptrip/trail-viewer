...
import { Mountain, TrendingUp, MapPin, Cloud, Wind, Droplets, Calendar } from 'lucide-react';
import { getElevationProfile, fetchWeather } from '../utils';

export default function Sidebar({ track, onClose }) {
